...
1. Call `mcp__android-debugger__connection_status`. If `attached: true`, ask the user whether to detach first (don't auto-detach — they may have active breakpoints). If they confirm, call `/android-debugger:detach`, then continue.
