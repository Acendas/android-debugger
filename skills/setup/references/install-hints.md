...
Read this from `/android-debugger:setup` step 3 when `adb_status: "not_found"` (or JDK is missing/too old). Platform-specific commands and env-var hints kept out of the skill body so URLs and cask names can be updated without rewriting the body.
