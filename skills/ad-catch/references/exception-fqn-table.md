...
Canonical for `/android-debugger:ad-catch`. Two responsibilities:
...
Read by `/android-debugger:ad-catch` step 2 (resolution) and step 2.5 (yellow-flag check). Update here when new exceptions surface in support reports.
