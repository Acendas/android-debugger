...
Read this from `/android-debugger:detach` if the user asks why detach is safe — i.e. "won't this kill my app?" or "what does detach actually do?". Documentation, not instruction-for-Claude.
